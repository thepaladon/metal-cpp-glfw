...
The `metal-cpp-extensions` code was taken from this [Apple sample](https://developer.apple.com/metal/LearnMetalCPP.zip) and a couple of methods where added to `NS::Window` and `NS::View` to allow Metal to be set-up, as this code does not use `MetalKit`.
